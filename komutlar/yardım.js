...
exports.run = (client, message, params) => {
  ...
  .addField("**Yapımcı**", " **Recep | Fides#9190 ve ! NEON ✯ Alysha :crescent_moon: :black_heart: A :black_heart:#8661 ** ")
  if (!params[0]) {
